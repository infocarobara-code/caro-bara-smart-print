...
export const pageText = {
  ...
  statsDescription: {
    ...
    en: "These metrics reflect how requests are structured and transformed into clear, execution-ready formats.",
  },
  ...
  requestsStatNote: {
    ...
    en: "Requests are structured before execution to ensure accuracy.",
  },
  servicesStatNote: {
    ar: "مجموعة متكاملة تغطي الطباعة، الإعلان، والتجهيزات التجارية.",
    de: "Ein umfassendes Angebot für Druck, Werbung und Geschäftsausstattung.",
    en: "A complete range covering print, advertising, and business setup.",
  },
  availabilityStatNote: {
    ar: "استقبال الطلبات 24/7 مع متابعة بشرية خلال أوقات العمل.",
    de: "24/7 Anfrageannahme mit persönlicher Betreuung während der Arbeitszeiten.",
    en: "24/7 request intake with human follow-up during working hours.",
  },
